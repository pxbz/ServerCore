...
public class TempBanSilentCommand extends BaseCommand {
    ...
    public CommandTriState executeCommand(@NotNull CommandSender sender, @NotNull String commandLabel, @NotNull String[] args) {
        ...
        return ModerationManager.tempbanPlayer(sender, args, banSilentNotificationPermission, expires);
    }
